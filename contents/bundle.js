...
(function(){
  ...
  console.log(history.pushState({}, "", "/foo"));
  console.log(location.href);
}).call(this);

},{"./elm":2}],2:[function(require,module,exports){
(function(scope){
'use strict';
...
var $author$project$Main$Model = F3(
	function (shared, page, url) {
		return {page: page, shared: shared, url: url};
	});
...
var $author$project$Main$fromUrl = function (url) {
	return A2(
		...
		$elm$core$Maybe$withDefault($author$project$Spa$Generated$Route$NotFound))(url);
};
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		var url_ = A3(
			...
			$elm$core$Maybe$withDefault(url),
			A3(
				$elm$core$Basics$composeR,
				$elm$url$Url$toString,
				A2($elm$core$String$replace, 'index.html', ''),
				url));
		var _v0 = A3($author$project$Shared$init, flags, url_, key);
		var shared = _v0.a;
		var sharedCmd = _v0.b;
		var _v1 = A2(
			$author$project$Spa$Generated$Pages$init,
			$author$project$Main$fromUrl(url_),
			shared);
		var page = _v1.a;
		var pageCmd = _v1.b;
		return _Utils_Tuple2(
			A3($author$project$Main$Model, shared, page, url_),
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
	...
	function (msg, model) {
		...
		switch (msg.$) {
			...
			case 'UrlChanged':
				...
				var _v2 = A2(
					$author$project$Spa$Generated$Pages$init,
					$author$project$Main$fromUrl(model.url),
					shared);
				var page = _v2.a;
				var pageCmd = _v2.b;
				return _Utils_Tuple2(
			...
			case 'Shared':
				...
				var shared = _v3.a;
				var sharedCmd = _v3.b;
				var _v4 = A2($author$project$Spa$Generated$Pages$load, model.page, shared);
				var page = _v4.a;
				var pageCmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				var pageMsg = msg.a;
				var _v5 = A2($author$project$Spa$Generated$Pages$update, pageMsg, model.page);
				var page = _v5.a;
				var pageCmd = _v5.b;
								...
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('link'),
											$elm$html$Html$Attributes$href(
											$author$project$Spa$Generated$Route$toString($author$project$Spa$Generated$Route$NotFound))
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('Not found')
